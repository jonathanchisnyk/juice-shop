...
module.exports = function fileUpload () {
  return (req, res, next) => {
    ...
    if (uploadedFileType !== null && utils.startsWith(uploadedFileType.mime, 'image')) {
      ...
      if (loggedInUser) {
        fs.open('frontend/dist/frontend/assets/public/images/uploads/' + encodeURIComponent(loggedInUser.data.id) + '.' + encodeURIComponent(uploadedFileType.ext), 'w', function (err, fd) {
